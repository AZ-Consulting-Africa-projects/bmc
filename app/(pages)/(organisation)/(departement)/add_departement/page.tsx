...
export default function AddDepartement() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            const resp = await Api.create('/api/departement', departementModel);
            if(resp.ok) {
                toast({
                    title: "departement ajouté avec succès",
                });
    ...
    return (
        <div className='flex flex-col space-y-10 mb-10'>
            {/** head */}
            <HeadDetaill title={"Ajouter un Departement"} subtitle={"Organisation mangement"} />
